...
default_params <- get_default_params("mlr3_project_R/config", "params_file.yml")
...
path <- get_path()
saveRDS(pred, file=paste0(path, "mlr3_project_R/prueba.rds"))
